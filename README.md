...
- `backend\timetodeny\` — Django project settings, URLs, ASGI/WSGI.
...
- `launchers\windows.bat` and `launchers\windows.ps1` — Windows launchers that start llama.cpp, Django, and Next.js.
