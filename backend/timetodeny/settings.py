...
TTD_MAX_PROMPT_CHARS = int(os.environ.get("TTD_MAX_PROMPT_CHARS", "12000"))
TTD_MAX_ATTACHMENTS = int(os.environ.get("TTD_MAX_ATTACHMENTS", "8"))
TTD_MAX_ATTACHMENT_CHARS = int(os.environ.get("TTD_MAX_ATTACHMENT_CHARS", "250000"))
...
TTD_WORKSPACE_MAX_FILE_BYTES = int(os.environ.get("TTD_WORKSPACE_MAX_FILE_BYTES", "1048576"))
