...
urlpatterns = [
    ...
    path("api/workspaces/<uuid:chat_id>/pending/file", views.workspace_pending_file),
    path("api/workspaces/<uuid:chat_id>/pending/apply", views.workspace_pending_apply),
    path("api/workspaces/<uuid:chat_id>/pending/reject", views.workspace_pending_reject),
    path("api/workspaces/<uuid:chat_id>/pending/test", views.workspace_pending_test),
